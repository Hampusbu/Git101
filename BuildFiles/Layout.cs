...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class Layout : Background, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage {
        ...
        private Neo.ApplicationFramework.Controls.Controls.Label m_GlobalPosition;
        ...
        private bool m_Initialized_Layout;
        
        public Layout() {
            this.InitializeComponent();
            this.Adapter.Closed += new System.EventHandler(this.Layout_Closed);
            this.Adapter.Opened += new System.EventHandler(this.Layout_Opened);
        ...
        protected Neo.ApplicationFramework.Controls.Script.TextControlCFAdapter GlobalPosition {
            get {
                return this.AdapterService.CreateAdapter<Neo.ApplicationFramework.Controls.Script.TextControlCFAdapter>(this.m_GlobalPosition);
            }
        }
        ...
        private void InitializeComponent() {
            ...
            this.m_GlobalPosition = new Neo.ApplicationFramework.Controls.Controls.Label();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.m_GlobalPosition)).BeginInit();
            ...
            this.m_Picture.ScreenOwnerName = "Layout";
            this.m_Picture.Stretch = true;
            this.m_Picture.SymbolName = "layout";
            ...
            this.m_Text.ScreenOwnerName = "Layout";
            this.m_Text.Top = 6;
            this.m_Text.VisibleDynamicsValue = true;
            this.m_Text.Width = 182;
            // 
            // m_Text2
            // 
            ...
            this.m_Text3.ScreenOwnerName = "Layout";
            ...
            this.m_Text4.ScreenOwnerName = "Layout";
            ...
            this.m_Text5.ScreenOwnerName = "Layout";
            this.m_Text5.Top = 253;
            ...
            // m_GlobalPosition
            // 
            this.m_GlobalPosition.BlinkDynamicsValue = false;
            this.m_GlobalPosition.DelayMouseInputPeriod = 0;
            this.m_GlobalPosition.EnabledDynamicsValue = true;
            this.m_GlobalPosition.FontSizePixels = 20;
            this.m_GlobalPosition.Height = 28;
            this.m_GlobalPosition.Left = 431;
            this.m_GlobalPosition.Name = "m_GlobalPosition";
            this.m_GlobalPosition.Padding = new Neo.ApplicationFramework.Common.Graphics.Logic.ThicknessCF(5D, 0D, 5D, 1D);
            this.m_GlobalPosition.ScreenOwnerName = "Layout";
            this.m_GlobalPosition.Top = 154;
            this.m_GlobalPosition.VisibleDynamicsValue = true;
            this.m_GlobalPosition.Width = 41;
            // 
            // m_Text6
            // 
            ...
            this.m_Text6.ScreenOwnerName = "Layout";
            this.m_Text6.Top = 103;
            this.m_Text6.VisibleDynamicsValue = true;
            this.m_Text6.Width = 112;
            // 
            // m_Text7
            // 
            ...
            this.m_Text7.ScreenOwnerName = "Layout";
            this.m_Text7.Top = 103;
            ...
            this.m_Initialized_Layout = true;
        ...
        public override void AddDrawingPrimitives() {
            ...
            this.DrawingPrimitives.Add(this.m_GlobalPosition);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.m_GlobalPosition)).EndInit();
        ...
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(Layout));
            this.m_Text.Text = resources.GetText("Layout.Text.Text", "LAYOUT DIAGNOSTICS");
            this.m_Text2.Text = resources.GetText("Layout.Text2.Text", "Current travel segment:");
            this.m_Text3.Text = resources.GetText("Layout.Text3.Text", "Text");
            this.m_Text4.Text = resources.GetText("Layout.Text4.Text", "Distance to end of segment:");
            this.m_Text5.Text = resources.GetText("Layout.Text5.Text", "Text");
            this.m_Text1.Text = resources.GetText("Layout.Text1.Text", "Global Position:");
            this.m_GlobalPosition.Text = resources.GetText("Layout.GlobalPosition.Text", "Text");
            this.m_Text6.Text = resources.GetText("Layout.Text6.Text", "Current Point:");
            this.m_Text7.Text = resources.GetText("Layout.Text7.Text", "Text");
