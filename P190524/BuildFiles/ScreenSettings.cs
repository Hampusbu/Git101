...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class ScreenSettings : Window640x420, Neo.ApplicationFramework.Interfaces.ISupportMultiLanguage {
        ...
        private bool m_Initialized_ScreenSettings;
        ...
        private void InitializeComponent() {
            ...
            this.m_TouchComboBox.FontSize = 20D;
            this.m_TouchComboBox.Foreground = System.Drawing.Color.Black;
            stringintervalmappercf1.DefaultValue = null;
            stringintervalcf1.End = 90D;
            stringintervalcf1.Start = 90D;
            stringintervalcf1.Value = "90";
            stringintervalcf2.End = 180D;
            stringintervalcf2.Start = 180D;
            stringintervalcf2.Value = "180";
            stringintervalcf3.End = 300D;
            stringintervalcf3.Start = 300D;
            stringintervalcf3.Value = "300";
            stringintervalcf4.End = 65000D;
            stringintervalcf4.Start = 65000D;
            stringintervalcf4.Value = "Off";
            ...
            this.m_TouchComboBox.Location = new System.Drawing.Point(375, 321);
            this.m_TouchComboBox.Name = "m_TouchComboBox";
            this.m_TouchComboBox.ScrollBarWidth = 20;
            this.m_TouchComboBox.SelectedBackground = new Neo.ApplicationFramework.Common.Graphics.Logic.BrushCF(System.Drawing.Color.FromArgb(((int)(((byte)(38)))), ((int)(((byte)(188)))), ((int)(((byte)(166))))), System.Drawing.Color.Empty, Neo.ApplicationFramework.Interfaces.FillDirection.None);
            ...
            this.m_TouchComboBox.Size = new System.Drawing.Size(101, 36);
            ...
            this.m_Picture.Left = 85;
            this.m_Picture.Name = "m_Picture";
            this.m_Picture.ScreenOwnerName = "ScreenSettings";
            this.m_Picture.Stretch = true;
            this.m_Picture.SymbolName = "settings";
            this.m_Picture.Top = 33;
            ...
            this.m_Text.ScreenOwnerName = "ScreenSettings";
            this.m_Text.Top = 38;
            this.m_Text.VisibleDynamicsValue = true;
            this.m_Text.Width = 200;
            // 
            // m_Text1
            // 
            ...
            this.m_Text2.ScreenOwnerName = "ScreenSettings";
            this.m_Text2.Top = 125;
            this.m_Text2.VisibleDynamicsValue = true;
            this.m_Text2.Width = 195;
            // 
            // m_Slider
            // 
            this.m_Slider.Background = new Neo.ApplicationFramework.Common.Graphics.Logic.BrushCF();
            this.m_Slider.BlinkDynamicsValue = false;
            this.m_Slider.DelayMouseInputPeriod = 0;
            this.m_Slider.EnabledDynamicsValue = true;
            this.m_Slider.Focus = false;
            this.m_Slider.FontSizePixels = 8;
            this.m_Slider.ForceTransparency = false;
            this.m_Slider.Foreground = new Neo.ApplicationFramework.Common.Graphics.Logic.BrushCF(System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(0))))), System.Drawing.Color.Empty, Neo.ApplicationFramework.Interfaces.FillDirection.None);
            this.m_Slider.Height = 57;
            this.m_Slider.IndicatorColor = new Neo.ApplicationFramework.Common.Graphics.Logic.BrushCF(System.Drawing.Color.FromArgb(((int)(((byte)(38)))), ((int)(((byte)(188)))), ((int)(((byte)(166))))), System.Drawing.Color.Empty, Neo.ApplicationFramework.Interfaces.FillDirection.None);
            this.m_Slider.IndicatorMargin = new Neo.ApplicationFramework.Common.Graphics.Logic.ThicknessCF(11.55D, 20.656666666666666D, 11.550000000000011D, 6D);
            this.m_Slider.InvalidateAtValueChanged = true;
            this.m_Slider.Left = 367;
            this.m_Slider.MajorScaleMarginFirst = new Neo.ApplicationFramework.Common.Graphics.Logic.ThicknessCF(11.55D, 18.656666666666666D, 11.550000000000011D, 4D);
            ...
            this.m_Slider.MajorTickCount = 2;
            this.m_Slider.Maximum = 100D;
            this.m_Slider.Minimum = 1D;
            this.m_Slider.MinorScaleMarginFirst = new Neo.ApplicationFramework.Common.Graphics.Logic.ThicknessCF(11.55D, 20.656666666666666D, 11.550000000000011D, 6D);
            ...
            this.m_Slider.ScreenOwnerName = "ScreenSettings";
            this.m_Slider.TextScaleMargin = new Neo.ApplicationFramework.Common.Graphics.Logic.ThicknessCF(5D, 5D, 5D, 42.343333333333334D);
            this.m_Slider.Top = 98;
            this.m_Slider.VisibleDynamicsValue = true;
            this.m_Slider.Width = 276;
            // 
            // m_Text3
            // 
            ...
            this.m_MultiPicture1.Left = 375;
            this.m_MultiPicture1.Name = "m_MultiPicture1";
            this.m_MultiPicture1.ScreenOwnerName = "ScreenSettings";
            ...
            this.m_Text10.ScreenOwnerName = "ScreenSettings";
            this.m_Text10.Top = 197;
            ...
            this.m_MultiPicture.Left = 375;
            this.m_MultiPicture.Name = "m_MultiPicture";
            this.m_MultiPicture.ScreenOwnerName = "ScreenSettings";
            ...
            this.m_Text4.ScreenOwnerName = "ScreenSettings";
            this.m_Text4.Top = 252;
            this.m_Text4.VisibleDynamicsValue = true;
            this.m_Text4.Width = 37;
            ...
            this.m_Initialized_ScreenSettings = true;
        ...
        public override void AddControlsAndPrimitives() {
            if (!m_Initialized_ScreenSettings) {
                return;
            }
            this.AddControls();
        ...
        private void m_MultiPicture1_Action_MouseDown(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_MultiPicture1", "MouseDown", "Set Tag", "Tags.DisableLockscreen", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.DisableLockscreen.SetTag();
        }
        
        private void m_Text10_Action_MouseDown(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Text10", "MouseDown", "Set Tag", "Tags.DisableLockscreen", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.DisableLockscreen.SetTag();
        }
        
        private void m_MultiPicture_Action_MouseDown(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_MultiPicture", "MouseDown", "Reset Tag", "Tags.DisableLockscreen", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.DisableLockscreen.ResetTag();
        }
        
        private void m_Text4_Action_MouseDown(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Text4", "MouseDown", "Reset Tag", "Tags.DisableLockscreen", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.DisableLockscreen.ResetTag();
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(ScreenSettings));
            this.m_Text.Text = resources.GetText("ScreenSettings.Text.Text", "SCREEN SETTINGS");
            this.m_Text1.Text = resources.GetText("ScreenSettings.Text1.Text", "Disable PLC control of Screen Saver:");
            this.m_Text2.Text = resources.GetText("ScreenSettings.Text2.Text", "Screen brightness:");
            this.m_Text3.Text = resources.GetText("ScreenSettings.Text3.Text", "Inactivity Timeout [s]:");
            this.m_Text10.Text = resources.GetText("ScreenSettings.Text10.Text", "Yes");
            this.m_Text4.Text = resources.GetText("ScreenSettings.Text4.Text", "No");
            resources.ApplyTexts(this.m_TouchComboBox, "Texts", "ScreenSettings.TouchComboBox.Texts[0]", "90", "ScreenSettings.TouchComboBox.Texts[1]", "180", "ScreenSettings.TouchComboBox.Texts[2]", "300", "ScreenSettings.TouchComboBox.Texts[3]", "Off");
        ...
        public override void ConnectDataBindings() {
            ...
            this.m_Slider.DataBindings.Add(dynamicBinding2);
            this.m_DynamicBindings.Add(dynamicBinding2);
            Neo.ApplicationFramework.Common.Data.DynamicBinding dynamicBinding3 = new Neo.ApplicationFramework.Common.Data.DynamicBinding("Value", Neo.ApplicationFramework.Common.Data.DataItemProxyFactory.CreateProxy("Tags.DisableLockscreen"), "Value", true, System.Windows.Forms.DataSourceUpdateMode.Never, Neo.ApplicationFramework.Common.Dynamics.VariantValueConverterCF.Default);
            ...
            this.m_MultiPicture.DataBindings.Add(dynamicBinding4);
